...
public class DataRow {
    ...
    DataRow(int id, String title, int userId, String content, int likes, int dislikes) { //Update for userID and String Array of Comments - iterate thrrough and add addcomment button 
        mId = id;
        mTitle = title;
        mUserId = userId;
        mContent = content;
