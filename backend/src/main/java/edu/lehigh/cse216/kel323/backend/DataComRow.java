...
public class DataComRow {
     ...
     */
    DataComRow(int comId, String comment, int userId, int id) {
        mcomId = comId;
        mComment = comment;
        mUserId = userId;
        mId = id;
    ...
    /*
    DataComRow(int id, String title, int userId, String content, int likes, int dislikes) { //Update for userID and String Array of Comments - iterate thrrough and add addcomment button 
        mId = id;
        mTitle = title;
        mUserId = userId;
        mContent = content;
